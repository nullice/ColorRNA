...
复制本项目 [`./bin/ColorRNA.js`](https://raw.githubusercontent.com/nullice/ColorRNA/master/bin/ColorRNA.js)(压缩版本) 或 [`./bin/ColorRNA.min.js`](https://raw.githubusercontent.com/nullice/ColorRNA/master/bin/ColorRNA.min.js) 文件
